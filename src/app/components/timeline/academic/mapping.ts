import { TimelineAcademicProps } from './academic-data'

export const statusColors: Record<TimelineAcademicProps['status'], string> = {
...
export const typeColors: Record<TimelineAcademicProps['type'], string> = {
...
export const dateColors: Record<TimelineAcademicProps['status'], string> = {
  completed: 'bg-emerald-500 text-white',
  ongoing: 'bg-primary text-white',
  planned: 'bg-gray-300 text-gray-700',
}

export const typeLabels: Record<TimelineAcademicProps['type'], string> = {
