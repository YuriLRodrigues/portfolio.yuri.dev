...
export const features: Feature[] = [
  ...
  },
  {
    ...
    description:
      "Escolha entre modo claro, escuro e cores principais personalizadas.",
    icon: "Moon",
  },
  {
    title: "Multilíngue",
  ...
  },
  {
    ...
    description:
      "Arquitetura escalável e organizada para facilitar a manutenção.",
    icon: "Code",
  },
  {
  ...
  },
  {
    title: "API Eficiente",
    description:
      "Endpoints REST otimizados para alto desempenho e escalabilidade.",
    icon: "Layers",
  },
];
