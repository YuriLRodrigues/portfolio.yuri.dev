  ...
  return (
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        {' '}
        <rect id="Icons" x="-1088" y="-64" width="1280" height="800" fill="none"></rect>{' '}
        <g id="Icons1">
          {' '}
          <g id="Strike"> </g> <g id="H1"> </g> <g id="H2"> </g> <g id="H3"> </g> <g id="list-ul"> </g>{' '}
          <g id="hamburger-1"> </g> <g id="hamburger-2"> </g> <g id="list-ol"> </g> <g id="list-task"> </g>{' '}
          <g id="trash"> </g> <g id="vertical-menu"> </g> <g id="horizontal-menu"> </g> <g id="sidebar-2"> </g>{' '}
          <g id="Pen"> </g> <g id="Pen1"> </g> <g id="clock"> </g> <g id="external-link"> </g> <g id="hr"> </g>{' '}
          <g id="info"> </g> <g id="warning"> </g> <g id="plus-circle"> </g> <g id="minus-circle"> </g>{' '}
          <g id="vue"> </g> <g id="cog"> </g> <g id="logo"> </g> <g id="radio-check"> </g> <g id="eye-slash"> </g>{' '}
          <g id="eye"> </g> <g id="toggle-off"> </g> <g id="shredder"> </g> <g id="spinner--loading--dots-"> </g>{' '}
          <g id="react">
            {' '}
            <circle cx="32.001" cy="31.955" r="4.478" fill="#00d8ff"></circle>{' '}
            <path
          ...
          <g id="check-selected"> </g> <g id="turn-off"> </g> <g id="code-block"> </g> <g id="user"> </g>{' '}
          <g id="coffee-bean"> </g>{' '}
          <g id="coffee-beans">
            {' '}
            <g id="coffee-bean1"> </g>{' '}
          ...
          <g id="clipboard"> </g> <g id="clipboard-paste"> </g> <g id="clipboard-copy"> </g> <g id="Layer1"> </g>{' '}
        </g>{' '}
      </g>
    </svg>
  )
