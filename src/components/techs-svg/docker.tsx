  ...
  return (
    <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <g id="SVGRepo_iconCarrier">
        {' '}
        <circle cx="16" cy="16" r="14" fill="#1794D4"></circle> <path d="M18 7H16V9H18V7Z" fill="white"></path>{' '}
        ...
        <path
          ...
          fill="white"
        ></path>{' '}
        <path d="M9 13H7V15H9V13Z" fill="white"></path> <path d="M10 13H12V15H10V13Z" fill="white"></path>{' '}
        <path d="M15 13H13V15H15V13Z" fill="white"></path> <path d="M16 13H18V15H16V13Z" fill="white"></path>{' '}
        <path d="M21 13H19V15H21V13Z" fill="white"></path> <path d="M15 10H13V12H15V10Z" fill="white"></path>{' '}
